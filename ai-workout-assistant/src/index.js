...
document.addEventListener("DOMContentLoaded", async () => {
      ...
      <div class="flex-1 overflow-y-auto flex flex-col items-center w-full">
        ...
        <div class="relative w-full flex flex-row justify-center items-center">
          <img
            ...
            class="w-1/2"
          />
          <div id="chooseHelpBtn" class="absolute top-0 digital-button glow bg-neon-blue text-white font-bold py-1 px-2 rounded-lg cursor-pointer hover:bg-neon-purple">Need Help ?</div>
        </div>
    ...
    htmlChooseWO += isSettings
      ...
      : `
        ...
        <button
          id="submitWOBtn"
          type="submit"
          class="w-full digital-button glow bg-neon-blue text-white py-2 text-xl font-bold rounded-lg mb-2 mt-5 hover:bg-neon-purple"
        >
          Next
        </button>
      `;
  ...
  segHowToUseBtnElem.addEventListener("click", () => {
    // Show body how to use element
    if (bodyHowToUseElem.style.display !== "none") return;
    bodyHowToUseElem.style.display = "block";
    segHowToUseBtnElem.classList.add("bg-neon-blue", "text-white");
  });
  ...
  recordKeypointsBtnElem.addEventListener("click", () => {
    ...
    if (WOPose.isExtractKeypoints) {
      ...
      pingRecordElem.classList.add("bg-neon-red");
      pingRecordElem.children[0].style.display = "block";
    } else {
      pingRecordElem.classList.remove("bg-neon-red");
    ...
    Object.keys(bestScore).forEach((nameWO) => {
      ...
      Object.keys(bestScore[nameWO]).forEach((durationWO, idx) => {
        ...
        htmlBestScore += `
          ...
          >
            <div
              class="p-1 bg-neon-blue text-center font-medium text-sm text-white"
            >
              ${durationWO}
            </div>
  ...
  const downloadScoresBtnElem = document.getElementById("downloadScoresBtn");

  downloadScoresBtnElem.addEventListener("click", () => {
    // Download the currently visible scores (journey or best)
    if (bodyJourneyElem.style.display !== "none") {
      WOScore.exportToCSV();
    } else {
      WOScore.exportBestScoresToCSV();
    }
  });
  ...
  segJourneyBtnElem.addEventListener("click", () => {
    ...
    segBestBtnElem.classList.remove("bg-neon-blue", "text-white");
    segBestBtnElem.classList.add("bg-digital-medium", "text-gray-400");
    segJourneyBtnElem.classList.remove("bg-digital-medium", "text-gray-400");
    segJourneyBtnElem.classList.add("bg-neon-blue", "text-white");
  });
  ...
  segBestBtnElem.addEventListener("click", () => {
    ...
    segJourneyBtnElem.classList.remove("bg-neon-blue", "text-white");
    segJourneyBtnElem.classList.add("bg-digital-medium", "text-gray-400");
    segBestBtnElem.classList.remove("bg-digital-medium", "text-gray-400");
    segBestBtnElem.classList.add("bg-neon-blue", "text-white");
  });
  ...
  segSettingsWOBtnElem.addEventListener("click", () => {
    ...
    segSettingsAdvBtnElem.classList.remove("bg-neon-blue", "text-white");
    segSettingsAdvBtnElem.classList.add("bg-digital-medium", "text-gray-400");
    segSettingsWOBtnElem.classList.remove("bg-digital-medium", "text-gray-400");
    segSettingsWOBtnElem.classList.add("bg-neon-blue", "text-white");
  });
  ...
  segSettingsAdvBtnElem.addEventListener("click", () => {
    ...
    segSettingsWOBtnElem.classList.remove("bg-neon-blue", "text-white");
    segSettingsWOBtnElem.classList.add("bg-digital-medium", "text-gray-400");
    segSettingsAdvBtnElem.classList.remove("bg-digital-medium", "text-gray-400");
    segSettingsAdvBtnElem.classList.add("bg-neon-blue", "text-white");
  });
