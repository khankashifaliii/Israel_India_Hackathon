...
33-Point Pose Detection (Google ML Kit)
...
AI Chatbot powered by Gemini (real-time biomechanics Q&A)
...
3 IMUs (ankles + back) → captures both gait mechanics + fall dynamics.
